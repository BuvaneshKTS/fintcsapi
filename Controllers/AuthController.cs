    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> UpdateUser(int id, [FromBody] RegisterDto dto)
        {
            try
            {
                ...
                user.EDPNo = dto.EDPNo ?? user.EDPNo;
                user.Name = dto.Name ?? user.Name;
                user.AddressOffice = dto.AddressOffice ?? user.AddressOffice;
                user.AddressResidential = dto.AddressResidential ?? user.AddressResidential;
                user.Designation = dto.Designation ?? user.Designation;
                user.PhoneOffice = dto.PhoneOffice ?? user.PhoneOffice;
                user.PhoneResidential = dto.PhoneResidential ?? user.PhoneResidential;
